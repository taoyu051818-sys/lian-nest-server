 ...
 *
 * Reusable constitution-health check functions extracted from
 * check-constitution-health.js so they can be imported by the
 * self-cycle runner and other agent scripts.
 */
